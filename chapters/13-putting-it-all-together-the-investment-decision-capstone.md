...
![The Sharpe benefit plateaus at 15%; the downside risk does not — the gap between the two panels is where the sizing decision lives](images/13-putting-it-all-together-the-investment-decision-capstone-fig-01.png)
